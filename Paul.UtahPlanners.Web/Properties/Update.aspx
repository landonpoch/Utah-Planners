<%@ Page Title="" Language="VB" MasterPageFile="~/NoSidebar.master" AutoEventWireup="false" CodeFile="Update.aspx.vb" Inherits="Properties_Update" %>
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="This is a required field" ControlToValidate="txtUnits" Display="Dynamic"></asp:RequiredFieldValidator><br />
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="This is a required field" ControlToValidate="txt250sf" Display="Dynamic"></asp:RequiredFieldValidator><br />
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="This is a required field" ControlToValidate="txt250apts" Display="Dynamic"></asp:RequiredFieldValidator><br />
