...
namespace UtahPlanners.Infrastructure.Finder
{
    public class PropertiesIndexFinder : IPropertiesIndexFinder
    {
        ...
        public PropertiesIndexFinder(PropertyContext context)
        {
            _context = context;
        }
        ...
        private IQueryable<PropertyIndexDTO> FindFilteredIndexRecords(IndexFilter filter)
        {
    ...
    {
        public static IQueryable<PropertyIndexDTO> Sort(this IQueryable<PropertyIndexDTO> props, IndexSort sort)
        {
            //if (sort != null)
            //{
